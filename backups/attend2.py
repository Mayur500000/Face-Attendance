...
def markattendance(name):
    with open("C:\\Users\\91970\\Downloads\\Updated Attendence\\Online-Face-Attendance--master\\Online-Face-Attendance--master\\attendance.csv", "a") as f:
        now = datetime.now()
        ...
        with open("C:\\Users\\91970\\Downloads\\Updated Attendence\\Online-Face-Attendance--master\\Online-Face-Attendance--master\\overall_attendance.csv", "a", newline='') as overall_f:
            writer = csv.writer(overall_f)
            writer.writerow([name, datestring])
            # Calculate the number of entries in overall_attendance.csv
