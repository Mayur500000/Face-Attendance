...
img_elon=face_recognition.load_image_file("D:\Mayur\code\Online-Face-Attendance--master\Attendance\Elon.png")
img_elon=cv2.cvtColor(img_elon,cv2.COLOR_BGR2RGB)
img_elon_musk=face_recognition.load_image_file("D:\Mayur\code\Online-Face-Attendance--master\Attendance\Jack.png")
