...
def markattendance(name):
    if name in marked_names:
        messagebox.showinfo("Attendance", f"{name} exit has already been marked in this session!")
        return
    ...
    filename = f"out_{session_id}.csv"
    ...
    with open(file_path, "a", newline='') as f:
        ...
        messagebox.showinfo("Attendance", f"{name} exit is marked")
